...
pid_file = str(Path(argv[0]).resolve().parent) + '/OBD2_pids.csv'
...
class Sample:
    def __init__(self, make: str, model: str, year: str, sample_number: str, sample_path: str, kfold_n: int):
        # Sample Specific Meta-Data
        self.model:                     str = model
        self.year:                      str = year
        self.path:                      str = sample_path
        self.output_vehicle_dir:        str = make + "_" + model + "_" + year
        self.output_sample_dir:         str = sample_number
    ...
    def make_and_move_to_vehicle_directory(self):
        ...
        # mkdir(self.output_vehicle_dir+str(self.output_sample_dir))
        # chdir(self.output_vehicle_dir+str(self.output_sample_dir))
        # output_folder = self.output_vehicle_dir+str(self.output_sample_dir)

        # # This drills down three directories to './output/make_model_year/sample_index/' Make directories as needed
        # if not path.exists(output_folder):
        #     mkdir(output_folder)
        # chdir(output_folder)
        # print('output foler: ' + output_folder)
    ...
    def find_lex_thresholds(self, id_dict: dict):
        ...
        # TODO Where the hell do we get this from?
